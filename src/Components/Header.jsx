...
const Header = () => {
    return (
        <div className="hero min-h-[800px] h-calc-vh " style={{backgroundImage: 'url(https://i.ibb.co/6RrhXhZ/bannernew.jpg)'}}>
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-[80vh]">
            ...
            <Link to={'/card/all'}><button className="btn btn-primary">Explore Cakes</button></Link>
          </div>
        </div>
      </div>
    );
